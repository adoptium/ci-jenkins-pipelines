...
node ("master") {
  ...
  stage("printResults") {
    ...
    // Slack message:
    slackSend(channel: slackChannel, color: 'good', message: 'AdoptOpenJDK Jenkins Nightly Build & Test Pipeline Success Rating: '+overallNightlySuccessRating+' % <'+jenkinsUrl+'/view/Tooling/job/nightlyBuildAndTestStats/'+BUILD_NUMBER+'/console|Job>')
  }
}
